...
| `--sheet-panel-animation-name`          | `sheet-panel-fly-<side>`         | animation-name   | Keyframes name for the panel's entry animation (per-side default: `sheet-panel-fly-right`, `-left`, `-top`, `-bottom`).                                                              |
| `--sheet-panel-animation-duration`      | `300ms`                          | animation-duration | Duration of the panel's entry animation.                                                                                                                                           |
| `--sheet-panel-animation-easing`        | `ease`                           | animation-timing-function | Easing function for the panel's entry animation.                                                                                                                            |
| `--sheet-panel-animation-fill-mode`     | `both`                           | animation-fill-mode | Fill mode for the panel's entry animation.                                                                                                                                       |
| `--sheet-panel-exit-animation-name`     | `sheet-panel-fly-out-<side>`     | animation-name   | Keyframes name for the panel's exit animation (per-side default: `sheet-panel-fly-out-right`, `-left`, `-top`, `-bottom`).                                                           |
| `--sheet-panel-exit-animation-duration` | `300ms`                          | animation-duration | Duration of the panel's exit animation.                                                                                                                                            |
| `--sheet-panel-exit-animation-easing`   | `ease`                           | animation-timing-function | Easing function for the panel's exit animation.                                                                                                                             |
| `--sheet-panel-exit-animation-fill-mode` | `both`                          | animation-fill-mode | Fill mode for the panel's exit animation.                                                                                                                                        |
| `--sheet-overlay-animation-name`        | `sheet-overlay-fade-in`          | animation-name   | Keyframes name for the overlay's entry animation.                                                                                                                                    |
| `--sheet-overlay-animation-duration`    | `200ms`                          | animation-duration | Duration of the overlay's entry fade-in (runs in parallel with panel entry).                                                                                                       |
| `--sheet-overlay-animation-easing`      | `ease`                           | animation-timing-function | Easing function for the overlay's entry animation.                                                                                                                          |
| `--sheet-overlay-animation-fill-mode`   | `both`                           | animation-fill-mode | Fill mode for the overlay's entry animation.                                                                                                                                     |
| `--sheet-overlay-exit-animation-name`   | `sheet-overlay-fade-out`         | animation-name   | Keyframes name for the overlay's exit animation.                                                                                                                                     |
| `--sheet-overlay-exit-animation-duration` | `200ms`                        | animation-duration | Duration of the overlay's exit fade-out (runs in parallel with panel exit).                                                                                                        |
| `--sheet-overlay-exit-animation-easing` | `ease`                           | animation-timing-function | Easing function for the overlay's exit animation.                                                                                                                           |
| `--sheet-overlay-exit-animation-fill-mode` | `both`                        | animation-fill-mode | Fill mode for the overlay's exit animation.                                                                                                                                      |
