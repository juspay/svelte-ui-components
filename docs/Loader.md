...
| `--loader-spin-duration`        | `1.4s`       | animation     | Duration of the spin animation. Falls back through `--motion-duration`. Named `-spin-` rather than `-animation-` to avoid colliding with GridItem's unrelated `--loader-animation-duration`. |
| `--loader-spin-easing`          | `linear`     | animation     | Easing curve of the spin animation. Falls back through `--motion-easing`.                                                                                                                    |
