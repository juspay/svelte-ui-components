...
| bordered         | `boolean` | No       | `true`  | Whether to draw a border around the page buttons. Set to `false` for a borderless, text-style pager (e.g. inside a table footer that already has its own border). The active page keeps its filled background.                                                                                                          |
