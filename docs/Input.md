...
| mandatory            | `boolean`                                                              | No       | `false`             | Appends a required asterisk beside the label and sets `aria-required` on the field.                                                                                                                                       |
| forceError           | `boolean`                                                              | No       | `false`             | Forces the error border independent of `validationPattern` — for server/runtime-driven errors. Combines with the existing validation error state.                                                                         |
